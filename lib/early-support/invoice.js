...
/**
 * Create, finalize, mark paid out of band (Checkout already collected), and email
...
export async function sendItemizedInvoice({ stripe, repo, position, customerId, email, tier, amountCents, currency }) {
  ...
  // Clover (2026-02-25) rejected paid_out_of_band on finalizeInvoice
  // (unknown parameter → webhook 500). Mark paid on invoices.pay so
  // Checkout is not charged a second time, then email the receipt.
