...
export const LANDING_BODY_BEFORE = 'Early Support is how you stand with ';
export const LANDING_BODY_AFTER =
  ' before the next formal round. Choose an amount first — a login is optional. We record your support on our ledger and email a Stripe receipt plus an itemized invoice either way. Afterward, you can create an account to claim your position here.';
