...
/** Alabama SOS entity 000-514-953 — Domestic Corporation, Exists, formed 2018-04-04. */
export const ALABAMA_SOS_ENTITY_ID = '000-514-953';
/** Official entity detail. Direct record; hyphens optional in `corp`. */
export const ALABAMA_SOS_ENTITY_URL =
...
export const CUSTOM_TIER = { key: 'custom', label: 'Custom', hint: 'Support what you desire' };
...
export const SUCCESS_SUBHEAD =
  'Checkout is complete. Your position activates after Stripe confirms the payment — not from this page.';
export const POSITIONS_SUBHEAD =
  'The ledger record of your voluntary Early Support.';
export const TERMS_SUBHEAD =
  'Voluntary support to JD Productions Inc. — early_support_v0.';
export const PRIVACY_SUBHEAD =
  'How Early Support uses your email for checkout and the ledger.';
...
export const WHAT_IT_IS_TITLE = 'What it is';
export const LANDING_BODY_BEFORE = 'Early Support is voluntary support to ';
export const LANDING_BODY_AFTER = '';
/** Full paragraph for docs/tests; UI links PAYEE_NAME to Alabama SOS. */
export const LANDING_BODY = `${LANDING_BODY_BEFORE}${PAYEE_NAME}${LANDING_BODY_AFTER}`;
