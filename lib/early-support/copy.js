...
export const TIERS = {
  starter: { key: 'starter', label: 'Starter', amountCents: 10_000 },
  standard: { key: 'standard', label: 'Standard', amountCents: 25_000 },
  anchor: { key: 'anchor', label: 'Anchor', amountCents: 50_000 }
};

export const TIER_KEYS = Object.keys(TIERS);

export const CHECKOUT_PRODUCT_DESCRIPTION =
  'Voluntary Early Support payment to JD Productions Inc. Includes ledger record, email receipt, and itemized invoice. Not equity or a security. Not a guaranteed return. Not a charitable donation. Terms: early_support_v0.';

export const INVOICE_NOTES =
  'Payee: JD Productions Inc. Early Support is a voluntary payment; it is not equity or a security, not a guaranteed return, and not a charitable donation or 501(c)(3) contribution. An account is optional — the ledger record, Stripe receipt, and itemized invoice are provided either way. Any later formal instrument is a separate, counsel-prepared step; nothing converts silently. Payments are processed by Stripe; processor fees apply.';
...
export const LANDING_HEADLINE = 'Early Support';
export const LANDING_SUBHEAD = 'Stand with JD Productions before the next formal round.';

export const LANDING_BODY =
  'Early Support is a voluntary payment to JD Productions Inc. Pay first — a JD Productions Accounts login is optional. We record your support on our ledger and email a Stripe receipt plus an itemized invoice either way. After you pay, you may create an account to claim your position on this site.';
...
export function invoiceTermsFooter({ termsUrl, privacyUrl }) {
  return [
    'EARLY SUPPORT TERMS NOTICE: By paying you accept Early Support Terms early_support_v0.',
